...
const expectedHost = 'aws-1-ap-southeast-1.pooler.supabase.com';
...
if (!patternMatches) {
  console.error(
    `Expected pooled Supabase credentials: user should include ".bvywkbqhmtsgeevwzbba" and host should be "${expectedHost}" on port 6543.`
  );
  process.exit(1);
}
