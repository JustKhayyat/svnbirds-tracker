...
export default async function handler(req, res) {
  try {
    ...
    // create admin client and request a signed upload URL (preferred API)
    ...
    if (error) {
      console.log('upload-url createSignedUploadUrl error', error);
    ...
    // returned signed URL can be relative (starts with "/"), make absolute
    ...
    // return path, signedUrl, and token (client can PUT to signedUrl or use token + uploadToSignedUrl)
